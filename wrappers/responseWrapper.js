module.exports = function(app){
    ...
    //if(app.response.locals ==null || app.response.locals == undefined) app.response.locals = {};
    //if(app.response.locals.middleParams == null || app.response.locals.middleParams == undefined) app.response.locals.middleParams = {};
